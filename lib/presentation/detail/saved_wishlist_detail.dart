...
class SavedWishlistDetail extends StatefulWidget {
  const SavedWishlistDetail({super.key});

  @override
  State<SavedWishlistDetail> createState() => _SavedWishlistDetailState();
}

class _SavedWishlistDetailState extends State<SavedWishlistDetail> {
  String selectedSize = '';
  bool isCart = false;
  bool isWish = false;
